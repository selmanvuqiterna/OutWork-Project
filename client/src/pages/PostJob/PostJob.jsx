    ...
    <div className="PostJob">
      ...
      <div className="container-post-job">
        ...
        <p className="post-job-kushti">
          Plotëso informatat e shpalljes (Shpallja juaj do të postohet brenda 24
          orëve!)
        </p>
        <form
          action=""
        ...
        >
          <div className="post-job-informatat">
            <div className="post-job-informata-shpallje">
              ...
              <div className="container-post-job-form-label">
                <label htmlFor="inputCategory" className="post-job-form-label">
                  Kategoria
                </label>
            ...
            <div className="post-job-informata-kontakti">
              ...
              <div className="container-post-job-form-label">
                <label htmlFor="inputTelefoni" className="post-job-form-label">
                  Telefoni
                </label>
